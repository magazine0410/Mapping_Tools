...
namespace Mapping_Tools.Classes.HitsoundStuff {
    ...
    public class LayerImportArgs : INotifyPropertyChanged, IEquatable<LayerImportArgs> {
        ...
        public ImportType ImportType {
            ...
            set {
                if (importType != value) {
                    ...
                    NotifyPropertyChanged("CoordinateVisible");
                    NotifyPropertyChanged("KeysoundVisible");
                }
            }
        }
        ...
        /// 
        /// </summary>
        public bool CoordinateVisible => ImportType == ImportType.Stack;

        /// <summary>
        /// 
        /// </summary>
        public bool KeysoundVisible => ImportType == ImportType.MIDI;
